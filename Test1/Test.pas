...
var
  FTest: TFTest;
   I, io,id,inn,iss,ip,im,iz  : Integer;
   t : integer = 300;
implementation
...
LOk.Left := (ClientWidth div 2)-(LOk.Left div 4)-(LOk.Left div 4);
...
begin
 ...
 begin
  ...
  begin
    LAnsw.Caption := RGYesNo.Items[0];
    end;
      If RGYesNo.ItemIndex = 1 then
  begin
    LAnsw.Caption := RGYesNo.Items[1];
    end;
      If RGYesNo.ItemIndex = 2 then
  begin
    LAnsw.Caption := RGYesNo.Items[2];
    end;
      If RGYesNo.ItemIndex = 3 then
  begin
    LAnsw.Caption := RGYesNo.Items[3];
    end;
      If RGYesNo.ItemIndex = 4 then
  begin
    LAnsw.Caption := RGYesNo.Items[4];
    end;
      If RGYesNo.ItemIndex = 5 then
  begin
    LAnsw.Caption := RGYesNo.Items[5];
    end;
 ...
 iz := random(4);
  ...
  begin
   ...
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Ио'));
   // активировать запрос
   ADOQParamRes.Active := True;
   ...
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(io)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Ид'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(id)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Ин'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(inn)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Ис'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(iss)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Ип'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(ip)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Им'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(im)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Из'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(iz)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
