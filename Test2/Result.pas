...
L1.Caption:= 'Правильных ответов ='+inttostr(ALL);
Label1.Caption:= 'Общее время ='+inttostr(t);
Label2.Caption:= 'Ин ='+inttostr(inn);
Label3.Caption:= 'Ис ='+inttostr(iss);
Label4.Caption:= 'Ип ='+inttostr(ip);
Label5.Caption:= 'Им ='+inttostr(im);
Label6.Caption:= 'Из ='+inttostr(iz);
